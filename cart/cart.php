		...
		<?php
			...
			$sql="SELECT * FROM medicine WHERE medId IN (";
					...
					while($row=mysqli_fetch_array($query)){
						if($_SESSION['cart'][$row['medId']]['quantity']>=1){
						$subtotal=$_SESSION['cart'][$row['medId']]['quantity']*$row['price'];
						$totalprice+=$subtotal;}
					?>
					<?php if($_SESSION['cart'][$row['medId']]['quantity']>=1){?>
						<tr>
			...
			//$sql2="insert into medicineorder(medicinename) values('".$row['medName']."')";
              ...
              /* $result2= mysqli_query($conn,$sql2)or die(mysqli_error($conn));
                ...
                //$sql1="insert into medicineorder(ordercusname,orderphone,orderaddress,medicinename,totalprice,medprice,medquantity) values('".$cuName."', '".$cuMobile."','".$cuAddress."','".$row['medName']."','".$totalprice."','".$row['price']."','".$_SESSION['cart'][$row['medId']]['quantity']."')";
                $sql1="INSERT INTO medicineorder(ordercusname,orderphone,orderaddress,medicinename,totalprice,medprice,medquantity) SELECT '".$cuName."', '".$cuMobile."','".$cuAddress."','".$row['medName']."','".$totalprice."','".$row['price']."','".$_SESSION['cart'][$row['medId']]['quantity']."' FROM dual WHERE ".$_SESSION['cart'][$row['medId']]['quantity'].">=1";
