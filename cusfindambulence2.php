...
<body class="cusfamb" style="font-family: 'Yusei Magic', sans-serif;">
<style>
.cusfamb {
...
.ll {
    ...
    <div class="">
        <div class="header-top">
            <div class="container">
                <a href="cupanel.php"><img src="img/client-1295901_960_720.png" style="max-height: 5%;max-width: 5%;margin-left: 47%;opacity:1.0;"></a>
                ...
                <tbody>
                    <?php
                      if ($_SERVER["REQUEST_METHOD"] == "POST"){
                        ...
                        $result = mysqli_query($con,"SELECT * FROM doctor where Department='".$str1."';") or die("Failed to fetch".mysql_error());
